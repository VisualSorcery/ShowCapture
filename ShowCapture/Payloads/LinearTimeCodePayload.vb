Public Class LinearTimeCodePayload
    Inherits Payload
    ...
    Private _value As LinearTimeCodeValue
    Public ReadOnly Property Value As LinearTimeCodeValue
        Get
            Return _value
        End Get
    End Property
    ...
    Public Function GetContainer() As LinearTimeCodeValue

        Dim ltc As New LinearTimeCodeValue
    ...
    Private Sub ReadFromBytes(buffer() As Byte)
        ...
        _value = New LinearTimeCodeValue
    ...
    Public Sub SetValue(value As LinearTimeCodeValue)
